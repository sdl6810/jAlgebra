...
public class Polynomial_v8
{
	...
	public Polynomial_v8(String _variable, boolean userInput, ArrayList<Double> coefficients, ArrayList<Integer> exponents)
	{
		if (userInput)
		{
			...
			this.extractTerms();
			this.extractCoefficients(_variable);
			this.extractExponents(_variable);
		...
		else if (!userInput)
		{
			...
			this.constructPolynomial(this.coefficients, this.exponents);
			this.determineDegree();
			this.variable = _variable;
		}
	}
	...
	*/
	...
	public void constructPolynomial(ArrayList<Double> coefficients, ArrayList<Integer> exponents)
	{
		for (int i = 0; i <= coefficients.size()-1; i++)
		{
			this.expression = this.expression + String.valueOf(coefficients.get(i))+this.variable+"^"+String.valueOf(exponents.get(i));
		}
	}

	public static void main(String[] args)
	{
		/*Polynomial_v8 p = new Polynomial_v8("x",true,null,null);
