...
public class Polynomial_v4
{
	...
	public Polynomial_v4(String variable)
	{
	...
	private void extractCoefficients(String variable)
	{
		...
		for (int k = 0; k<=this.terms.size()-1;k++)
		{
			...
			//if the first character is just the variable itself
	...
	*/
	...
	{
		Polynomial_v4 p = new Polynomial_v4("x");
		...
		double evaluate = p.reconstructAndEvaluate(-7);
